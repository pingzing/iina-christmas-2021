...
using IinaChristmas.Core.XamlExtensions;
using System;
...
namespace IinaChristmas.Core.SpecialEvents
{
    public class PinkieEventService
    {
        ...
        private static readonly PinkieEvent _firstTimeEvent = new PinkieEvent(_firstTimeScriptGuid)
        {
            ...
            { "pinkie_bounce_up_3.png", "Oh! Oh, you're a brand new face!", 3000 },
            { null, "Ohmigosh, this is so exciting!", 3000 },
            { "pinkie_confused.png", "How are you doing? I hear you're busy fighting back against a big ol' meanie-face.", 4000 },
            { null, "Me and my friends are rooting for you! If I could, I'd bake you the biggest-est, bestest cake EVER!", 5000 },
            { "pinkie_bounce_up_3.png", "Oh shoot! I gotta go! It was really great to meet you though! Byeeee!", 4000 },
        };
